...
\begin{itemize}
    \item \textbf{Chi Kit WONG: 5/5.}
    He provided strong technical leadership throughout the project by
    establishing the research direction, designing the security evaluation
    framework, and coordinating the overall development process. His
    expertise in threat modeling, experiment design, and artifact management
    ensured that the project maintained a clear research objective and a
    high level of reproducibility.
    
    \item \textbf{Haotian WANG: 5/5.}
    He made essential contributions to the technical development of the
    project by building the core system pipeline and integrating the
    multi-agent workflow. His careful implementation and extensive
    experiment execution provided a reliable foundation for evaluating
    the proposed security mechanisms.

    \item \textbf{Boyong HOU: 5/5.}
    He made important contributions to preparing the project presentation
    slides and improving the communication quality of the project. His
    careful proofreading, documentation refinement, and feedback on the
    presentation helped ensure a polished and accessible final outcome.
\end{itemize}
