...
\item \textbf{Chi Kit WONG: 5/5.}
    Demonstrated outstanding leadership by defining the core research scope, architecting the security evaluation framework, and guiding overall execution. His strategic approach to threat modeling, experimental rigor, and artifact curation kept the project well-focused and ensured exceptional reproducibility.

    \item \textbf{Haotian WANG: 5/5.}
    Drove the primary technical implementation by constructing the core system pipeline and seamlessly integrating the multi-agent workflow. His meticulous coding and hands-on execution of experiments established a solid, dependable base for validating our security mechanisms.

    \item \textbf{Guanrun PENG: 5/5.}
    Played a vital role in elevating the project's overall presentation and visual communication. Through diligent proofreading, documentation polishing, and critical feedback on slide design, he ensured the final deliverables were clear, impactful, and professional.
\end{itemize}
